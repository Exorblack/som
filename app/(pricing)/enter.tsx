...
const enter = () => {
  return (
    <div>
      <div className="border-stone-600 rounded-2xl border  divide-y divide-gray-200 max-w-sm mx-auto mt-20 box-shadow: rgba(45, 50, 130, 0.15) 0px 12px 16px -4px, rgba(45, 50, 130, 0.15) 0px 4px 6px -2px;">
    <div className="p-6">
        <div className="flex justify-between">
            <h2 className="text-lg font-semibold text-gray-600">Enterprise</h2>
        </div>
        <p className="mt-0.5 text-sm text-gray-500">For established companies</p>
        <p className="mt-8"><span className="text-4xl font-bold tracking-tight text-gray-900">$129</span>
            <span className="text-base font-medium text-gray-500">/mo</span>
        </p>
        <a href="#" target="_blank"
            className="flex justify-center w-full py-3 mt-4 text-sm font-medium text-white bg-slate-700 border border-stone-400 rounded active:text-stone-950 hover:bg-transparent hover:text-stone-950 focus:outline-none focus:ring">Get
            started now</a>
    </div>
    <div className="px-6 pt-6 pb-8">
        ...
        <ul role="list" className="mt-6 space-y-4">
            ...
            <li className="flex space-x-3">
                ...
                <span className="text-sm text-gray-500">White labeled widgets and forms</span>
            </li>
            <li className="flex space-x-3">
                <div className="flex justify-center items-center rounded-full bg-green-100 h-5 w-5"><svg
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"
