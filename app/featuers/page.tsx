...
const featuers = () => {
  return (
    <main>
        <div className='flex justify-center items-center text-4xl font-bold py-10'> Features
        </div>
    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            <div className="mx-auto mb-7 inline-block"><svg width="53" height="61" viewBox="0 0 53 61" fill="none"
                    ...
                    <rect x="20.8433" y="19.3018" width="10.1675" height="12.201" fill="#496989"></rect>
            ...
            <div>
                <h3 className="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Free to Get Started
                </h3>
                <p className="text-base font-medium text-body-color">FormBold is free to use, we are offering a decent free
    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            <div className="mx-auto mb-7 inline-block"><svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        fill="#496989"></path>
                    <circle cx="46.6115" cy="11.4049" r="9.42147" fill="#496989"></circle>
                    <path
            ...
            <div>
                <h3 className="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Link Multiple Emails
                </h3>
                <p className="text-base font-medium text-body-color">Link multiple email address under your parent account,
    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            <div className="mx-auto mb-7 inline-block"><svg width="67" height="60" viewBox="0 0 67 60"
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        fill="#496989"></path>
                    <rect width="20.0016" height="13.3344" rx="2" fill="#496989"></rect>
                    <rect x="19" y="33" width="21" height="11" rx="2"
                        fill="#496989"></rect>
                    <rect x="39.8958" y="47.666" width="24.6688" height="11.3344" rx="2"
                        fill="white" stroke="#496989" stroke-width="2"></rect>
                    <rect x="21" y="18" width="45" height="10" rx="2"
                        fill="white" stroke="#496989" stroke-width="2">
                    </rect>
                </svg></div>
            <div>
                <h3 className="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Easy to Use Form API
                </h3>
                <p className="text-base font-medium text-body-color">Simple and easy-to use form API all you need to paste
    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            <div className="mx-auto mb-7 inline-block"><svg width="58" height="60" viewBox="0 0 58 60"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="1" y="1" width="24" height="26" rx="2"
                        stroke="#496989" stroke-width="2"></rect>
                    <path
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M31 10.5H26V8.5H31V10.5Z" fill="#496989">
                    </path>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M31 47H26V45H31V47Z" fill="#496989"></path>
            ...
            <div>
                ...
                <p className="text-base font-medium text-body-color">Connect apps and integrations with your form, get
    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            <div className="mx-auto mb-7 inline-block"><svg width="51" height="60" viewBox="0 0 51 60"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div>
                <h3 className="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Spam Free &amp;
                    Encrypted</h3>
                <p className="text-base font-medium text-body-color">We use server-side mechanism to make sure submissions
    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-xl py-8 px-7 shadow-md transition-all hover:shadow-lg sm:p-9 lg:px-6 xl:px-9">
            <div className="mx-auto mb-7 inline-block"><svg width="52" height="60" viewBox="0 0 52 60"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div>
                <h3 className="mb-4 text-xl font-bold text-black sm:text-2xl lg:text-xl xl:text-2xl">Attach Large Files
                </h3>
                <p className="text-base font-medium text-body-color">You can allow end users to attach or upload
